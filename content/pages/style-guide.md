...
<div class="note"><strong>Note:</strong> Обе функции, которые вы использовали выше, являются частью API Document Object Model (DOM), который позволяет манипулировать документами.</div>
