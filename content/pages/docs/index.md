...
унифицированный API между типами форм с <a href="/docs/3.0/manipulating/#move"><font style="vertical-align: inherit;">перемещением</a> (move), размером (size), центром (center), ...  
