...
<div class="note">
  ...
  Этот блок обозначает общее пПримечание. Все свойства, которые ранее были доступны для глобального объекта SVG, теперь необходимо импортировать, см. Пример ниже: примечание. 
</div>
```
